...
PROGDIR=/nfs/team205/nk5/Applications/EthnicityEst
VCFDIR=$1
OUTDIR=$1/SmartPCA
mkdir $OUTDIR
...
# SMARTPCA
$SMARTPCA -i $OUTDIR/genotype -a $OUTDIR/snp -b $OUTDIR/ind -e $OUTDIR/eval -l $OUTDIR/log -o $OUTDIR/out -p $OUTDIR/plot -m 0
bash $PROGDIR/GMC.sh $OUTDIR
